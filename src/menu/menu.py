        ...
        while True:
            ...
            if opcao == "1":
                ...
                if(status):
                    ...
                    print(Cores.VERDE + "\nLivro indisponivel, tente novamente outro dia!" + Cores.RESET)
                ...
                if(status):
                    ...
                    print(Cores.VERDE + "\nLivro indisponivel, tente novamente mais tarde!" + Cores.RESET)
                ...
                if(status):
                    ...
                    print(Cores.VERDE + "\Ocorreu um erro, livro indisponivel!" + Cores.RESET)
